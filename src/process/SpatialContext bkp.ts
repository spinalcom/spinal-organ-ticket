...
//   spinalRoomContext: SpinalContext;
//   spinalFloorContext: SpinalContext;
//   graph: SpinalGraph;
//   rooms: any[];
...
//   getRoomById(roomId: string): SpinalNode {
...
//   static spinalNodeGetParentRelation(node: SpinalNode, relationNames: string[]) {
//     const res = [];
...
//   async spinalNodeGetParent(node: SpinalNode, relationNames: string[]) {
...
//     if (room !== undefined) {
//       const n = SpinalGraphService.getRealNode(local);
//       const resFind = await n.find([...GEO_RELATIONS_NAMES, EQUIPMENT_RELATION], (obj) => {
...
//         for (const attr of attrs) {
//           if (attr.label.get() === 'ID MATERIEL') {
//             return this.formatNumberLength(<string>(attr.label.get()), 6);
//           }
//         }
//       }
//     }
